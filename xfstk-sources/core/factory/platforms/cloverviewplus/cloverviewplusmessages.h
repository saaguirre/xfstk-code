...
*/
#ifndef CLOVERVIEWPLUSMESSAGES_H
#define CLOVERVIEWPLUSMESSAGES_H
...
#define FW_UPDATE_PROFILE_OLD_HDR_SIZE_CLVP          0x1C
 ...
 * redefined warning messages. While I'm here, I might as well change
 * the #define to const int. It's best to utilize types when possible
 * imo. Jeff Wicks Wednesday, March 13, 2013.
 */
//#define MAX_ERROR_CODE                  49
const int MAX_ERROR_CODE_CLOVERVIEWPLUS = 49;
...
// OS Size offsets
//--#define GET_OS_N_SIZE_OFFSET(n) ((n * 0x14) + 0x1C)
...
//DxxM Op Code
#define DORM 0x3000
#endif // CLOVERVIEWPLUSMESSAGES_H
