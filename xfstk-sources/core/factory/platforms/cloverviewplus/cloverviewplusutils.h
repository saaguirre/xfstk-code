...
*/
#ifndef CLOVERVIEWPLUSUTILS_H
#define CLOVERVIEWPLUSUTILS_H
...
private:
	CloverviewPlusUtils( const CloverviewPlusUtils& );
	CloverviewPlusUtils& operator=( const CloverviewPlusUtils& );
};

#endif // CLOVERVIEWPLUSUTILS_H
