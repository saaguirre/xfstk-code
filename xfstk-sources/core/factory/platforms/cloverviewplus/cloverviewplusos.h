...
*/
#ifndef CLOVERVIEWPLUSOS_H
#define CLOVERVIEWPLUSOS_H
#include <memory>
...
private:
	...
	CloverviewPlusOS( const CloverviewPlusOS& );
	CloverviewPlusOS& operator=( const CloverviewPlusOS& );
};
#endif //CLOVERVIEWPLUSOS_H
