...
*/
#ifndef CLOVERVIEWPLUSEMMCDEVICE_H
#define CLOVERVIEWPLUSEMMCDEVICE_H
...
class CloverviewPlusEmmcDevice : public IDevice
{
public:
    CloverviewPlusEmmcDevice();
    ~CloverviewPlusEmmcDevice();
...
#else
class CloverviewPlusEmmcUSB20Device : public IDevice
{
public:
    CloverviewPlusEmmcUSB20Device();
    ~CloverviewPlusEmmcUSB20Device();
    int GetNumberAvailableDevices();
#if defined XFSTK_OS_WIN
    int GetNumberAvailableDevices(DeviceInfos * socdevices);
...
class CloverviewPlusEmmcSerialDevice : public IDevice
{
public:
    CloverviewPlusEmmcSerialDevice();
    int GetNumberAvailableDevices();
#if defined XFSTK_OS_WIN
...
#endif // CLOVERVIEWPLUSEMMCDEVICE_H
