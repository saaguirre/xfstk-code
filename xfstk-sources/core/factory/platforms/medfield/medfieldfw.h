...
const int FW_DATA_DNXH_MEDFIELD =  13; //FW dnx header

#define FW_DATA_DNXD_MFD	14 //FW dnx
#define FW_DATA_DNX0H_MFD	15 //FW zero size dnx header data

#define NUM_FW_DATA_MFD 16
...
private:
    ...
    dnx_data* fw_data_set[NUM_FW_DATA_MFD];

  MedfieldFW( const MedfieldFW& );
  MedfieldFW& operator=( const MedfieldFW& );
};
#endif //MEDFIELDFW_H
