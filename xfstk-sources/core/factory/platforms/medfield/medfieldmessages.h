...
*/
#ifndef MEDFIELDMESSAGES_H
#define MEDFIELDMESSAGES_H
...
#define FW_UPDATE_PROFILE_OLD_HDR_SIZE_MFD          0x1C
...
#define MAX_ACK_CODE_MEDFIELD           48
