...
*/
#ifndef HASHVERIFYUTILS_H
#define HASHVERIFYUTILS_H
...
private:
	HashVerifyUtils( const HashVerifyUtils& );
	HashVerifyUtils& operator=( const HashVerifyUtils& );
};

#endif // HASHVERIFYUTILS_H
