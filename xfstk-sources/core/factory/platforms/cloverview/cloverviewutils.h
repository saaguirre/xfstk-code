...
*/
#ifndef CLOVERVIEWUTILS_H
#define CLOVERVIEWUTILS_H
...
private:
	...
	CloverviewUtils( const CloverviewUtils& );
	CloverviewUtils& operator=( const CloverviewUtils& );
};

#endif // CLOVERVIEWUTILS_H
