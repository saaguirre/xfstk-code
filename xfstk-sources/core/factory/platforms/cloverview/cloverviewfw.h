...
*/
#ifndef CLOVERVIEWFW_H
#define CLOVERVIEWFW_H
...
const int FW_DATA_DNXH_CLOVERVIEW =  13; //FW dnx header

#define FW_DATA_DNXD_CLV	14 //FW dnx
#define FW_DATA_DNX0H_CLV	15 //FW zero size dnx header data

#define NUM_FW_DATA_CLV 16
...
private:
    ...
    dnx_data* fw_data_set[NUM_FW_DATA_CLV];

	CloverviewFW( const CloverviewFW& );
	CloverviewFW operator=( const CloverviewFW& );
};
#endif //CLOVERVIEWFW_H
