...
*/
#ifndef CLOVERVIEWMESSAGES_H
#define CLOVERVIEWMESSAGES_H
...
#define FW_UPDATE_PROFILE_OLD_HDR_SIZE_CLV          0x1C
...
#define MAX_ACK_CODE_CLOVERVIEW         48
