...
*/
#ifndef CLOVERVIEWDEVICE_H
#define CLOVERVIEWDEVICE_H
...
#define CLOVERVIEW_DEVICE_ID 0x3
#else
#include <usb.h>
#if 0
#include <libusb.h>
...
#define CLOVERVIEW_PRODUCT_ID  0xe006
#define USBSN_BUFFER_SIZE 128
#define MAX_SOC_DEVICES 32

class CloverviewDevice : public IDevice
{
public:
    CloverviewDevice();
    ~CloverviewDevice();
...
private:
	...
	CloverviewDevice( const CloverviewDevice& );
	CloverviewDevice& operator=( const CloverviewDevice& );
};

#ifdef XFSTK_OS_WIN

#else
class CloverviewUSB20Device : public IDevice
{
public:
    CloverviewUSB20Device();
    ~CloverviewUSB20Device();
    int GetNumberAvailableDevices();
    int GetNumberAvailableDevices(DeviceInfos * socdevices);
    void* GetDeviceHandle(int DeviceNumber);
...
class CloverviewSerialDevice : public IDevice
{
public:
    CloverviewSerialDevice();
    int GetNumberAvailableDevices();
