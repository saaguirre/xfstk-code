...
CONFIG += qt \
    console
TARGET = xfstk-dldr-solo

DESTDIR = $${DEST_DOWNLOADER_SOLO}
OBJECTS_DIR = $${OBJ_DOWNLOADER_SOLO}
MOC_DIR = $${MOC_DOWNLOADER_SOLO}
...
QMAKE_LIBS_THREAD += -lpthread \
    -lrt
HEADERS += $${SRC_DOWNLOADER_SOLO}/xfstkdownloader.h
SOURCES += $${SRC_DOWNLOADER_SOLO}/xfstkdownloader.cpp \
    $${SRC_DOWNLOADER_SOLO}/xfstkdownloadermain.cpp
